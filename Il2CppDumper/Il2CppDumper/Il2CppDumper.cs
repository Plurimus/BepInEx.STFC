    ...
    public static class Il2CppDumper
    {
	        ...
	        Config config, Action<string> reportProgressAction)
        {
	        ...
	        if (config.GenerateStruct)
	        {
                ...
                decompiler.Decompile(config, outputDirectoryPath);
                                 ...
                                 out Il2Cpp il2Cpp)
        {
            ...
            InitFromProgram(il2cppPath, metadataPath, config, out var metadata2, out var il2Cpp2);
            metadata = metadata2;
            il2Cpp = il2Cpp2;
           
        }

        private static bool InitFromProgram(string il2cppPath, string metadataPath, Config config, out Metadata metadata, out Il2Cpp il2Cpp)
        {
